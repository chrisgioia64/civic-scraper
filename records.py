...
class CommitteeData:
    ...
    def printInformation(self):
        print("Committee: " + self.name)
        print("URL: " + self.url)
        print("Meetings:")
        for meeting in self.meetings:
            print("   Date: " + str(meeting.date))
            if meeting.agenda is not None:
                print("   Agenda: " + meeting.agenda.file_name + " URL: " + meeting.agenda.file_url)
            if meeting.minutes is not None:
                print("   Minutes: " + meeting.minutes.file_name + " URL: " + meeting.minutes.file_url)
            print("")
